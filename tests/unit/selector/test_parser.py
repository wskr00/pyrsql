...
def test_parse_function_selector_builds_nested_arguments() -> None:
    """Parses nested function selectors into selector arguments."""
    selector = SelectorParser().parse(
        "@upper[name|#1]",
        max_length=100,
        context="selector",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "@upper[]",
            r"must have at least one argument",
            SelectorParseError,
